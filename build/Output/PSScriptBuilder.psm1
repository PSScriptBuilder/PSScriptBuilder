...
class PSScriptBuilderContentCollector {
    ...
    .DESCRIPTION
        ...
        dependency analysis â€” a collision would cause silent incorrect ordering in the build output.
    ...
    .DESCRIPTION
        ...
        Note: If a Class and a Function share the same name, only one entry will appear in the result â€” 
...
class PSScriptBuilderDependencyAnalyzer {
    ...
    [PSScriptBuilderDependencyAnalysisResult] Analyze() {
        try {
            ...
            # Step 7: Stabilize â€” enums always before classes and functions
...
class PSScriptBuilderReleaseManagementOrchestrator {
    ...
    hidden [OrderedDictionary] BuildReleaseDataChanges([PSCustomObject] $originalData, [PSCustomObject] $modifiedData) {
        ...
        foreach ($versionProperty in $versionProperties) {
            ...
            # Normalize null and empty string â€” both mean "no value" (JSON stores "" for null)
...
class PSScriptBuilderDependencyGraphRenderer {
    ...
    static [string] RenderMermaid([PSScriptBuilderDependencyGraph] $graph, [bool] $includeEdgeTypes) {
        ...
        # they appear implicitly as targets â€” no extra lines needed for Mermaid.
...
$Global:PSScriptBuilderModuleInfo = [ordered] @{
    ...
    Version        = '1.1.0'
    BuildTimestamp = '2026-05-05T16:16:57Z'
    BuildNumber    = '27'
    GitCommit      = '414e632'
    GitBranch      = 'main'
}
