...
<img src="https://raw.githubusercontent.com/PSScriptBuilder/PSScriptBuilder/main/images/brand/banner-v3_1200x630.png" alt="PSScriptBuilder" width="750">

[![PowerShell Gallery](https://img.shields.io/powershellgallery/v/PSScriptBuilder.svg?style=for-the-badge)](https://www.powershellgallery.com/packages/PSScriptBuilder)
[![Downloads](https://img.shields.io/powershellgallery/dt/PSScriptBuilder.svg?style=for-the-badge)](https://www.powershellgallery.com/packages/PSScriptBuilder)
[![Platform](https://img.shields.io/powershellgallery/p/PSScriptBuilder.svg?style=for-the-badge)](https://www.powershellgallery.com/packages/PSScriptBuilder)

[![PowerShell](https://img.shields.io/badge/powershell-5.1%2B-blue.svg?style=for-the-badge)](https://github.com/PowerShell/PowerShell)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=for-the-badge)](https://opensource.org/licenses/MIT)
[![Website](https://img.shields.io/badge/website-psscriptbuilder.com-blue?style=for-the-badge)](https://psscriptbuilder.com)
[![Documentation](https://img.shields.io/badge/documentation-docs.psscriptbuilder.com-blue?style=for-the-badge)](https://docs.psscriptbuilder.com)
...
- **Automatic Dependency Ordering** — Uses topological sort and AST analysis to resolve class inheritance, type dependencies, and inter-file relationships; output is always in valid load order
...
- **Configurable Collectors** — Dedicated, customizable collectors for Classes, Functions, Enums, Using statements, and raw Files
...
Fifteen runnable examples are included in the [`examples/`](examples/) directory, covering scenarios from simple function builds to full release workflows with scaffolding, compression, and real-time file watching.
