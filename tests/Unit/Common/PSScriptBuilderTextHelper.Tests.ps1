...
Describe 'PSScriptBuilderTextHelper' {
    ...
    Context 'FormatCollectorType' {
        ...
        It 'Should return "Using" for UsingCollector' {
            $result = [PSScriptBuilderTextHelper]::FormatCollectorType([PSScriptBuilderCollectorType]::UsingCollector)
            $result | Should -Be 'Using'
        }

        It 'Should return "File" for FileCollector' {
            $result = [PSScriptBuilderTextHelper]::FormatCollectorType([PSScriptBuilderCollectorType]::FileCollector)
            $result | Should -Be 'File'
        }
    }
