...
Fourteen standalone, runnable examples cover the complete PSScriptBuilder feature set — designed
...
| [13](#13-dependency-analysis) | Dependency and Code Analysis | Analyzing component relationships and codebase metrics without building |
