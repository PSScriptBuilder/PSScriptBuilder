...
```powershell title="HRTools.ps1 — before migration"
enum Department {
    Engineering
    HumanResources
    Finance
...
Create the template at `build/Templates/HRTools.ps1.template`:
...
Open `build/Output/HRTools.ps1` and compare it with your original file. The content should
