...
**version bump, file update, module build, demo**. All four phases run in sequence, showing
how release management and script building work together end to end.

## New in this example

- All phases combined: release management *and* build in one script
...
**The four phases of a full workflow:**
...
| 4 - Demo | `Demo-Module.ps1` | Loads built module, confirms version, exercises types |
...
5. `Demo-Module.ps1` loads the built module with `using module`, reads the version from the manifest, and exercises strongly-typed `ConfigEntry` and `AppConfig` objects
