...
+-- build/
    +-- Templates/
    |   +-- HRTools.ps1.template           Template with three placeholders
...
3. `Invoke-PSScriptBuilderBuild` analyzes dependencies, sorts components, fills the template, and writes `build\Output\HRTools.ps1`
